...
function createSongCard(songData) {
    ...
    card.innerHTML = `
        <img src="${(songData.artUrl && songData.artUrl.startsWith('http')) ? songData.artUrl : '/' + (songData.artUrl || 'img/song-holder.png')}" alt="${songData.title}" class="album-art" loading="lazy">
...
function createSongListItem(songData, index, artistNameToDisplay) {
    ...
    songItem.innerHTML = `
        ...
        <img src="${(songData.artUrl && songData.artUrl.startsWith('http')) ? songData.artUrl : '/' + (songData.artUrl || 'img/song-holder.png')}" alt="${songData.title || 'Art'}" class="album-art-small">
