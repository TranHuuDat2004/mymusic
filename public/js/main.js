...
// Đăng ký Service Worker để lưu cache nhạc/ảnh tại trình duyệt của người dùng nhằm tiết kiệm băng thông Supabase
if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        navigator.serviceWorker.register('/service-worker.js')
            .then((reg) => console.log('Service Worker đã đăng ký thành công trên trình duyệt! Scope:', reg.scope))
