// js/ui.js - Module quản lý các thành phần UI chung

/**
 * Tìm thẻ <main> hiện có, tạo và chèn footer vào cuối nó.
 * Hàm này nên được gọi trong DOMContentLoaded của mỗi trang.
 */
function initializeMainFooter() {
    // Tìm thẻ <main> trong trang hiện tại.
    // Chúng ta dùng querySelector vì có thể có nhiều id khác nhau (home-content, library-content...)
    const mainContentContainer = document.querySelector('.main-content');

    if (!mainContentContainer) {
        console.warn("UI.js: Không tìm thấy thẻ <main class='main-content'> để chèn footer.");
        return;
    }
    ...
    // HTML của footer mới, được sắp xếp lại cho phù hợp với dự án
    footerElement.innerHTML = `
        <div class="footer-links-container">
            ...
            <div class="footer-column">
                ...
                <ul>
                    <li><a href="https://github.com/TranHuuDat2004/mymusic" target="_blank" rel="noopener noreferrer">Mã nguồn (GitHub)</a></li>
                    <li><a href="https://github.com/TranHuuDat2004/mymusic/issues">Báo cáo sự cố</a></li>
                </ul>
            </div>
    ...
    console.log("Main content footer initialized.");
}

// Chạy hàm này khi DOM đã sẵn sàng
document.addEventListener('DOMContentLoaded', initializeMainFooter);